		...
		<div id="container">
			<div id="content">
				<div id="logoImgHolder">
					<img src="http://www.idealdeals.co.nz/images/ideal-logo.png" alt="ideal deals" width="512" height="615" />
					<!--end .logoImgHolder-->
				</div>
...
if($error == 'email') {
	...
	include ("../private_application/views/includes/subscribe_form.php");
					...
					<div class="followBtnHolder">
						...
						src="http://www.idealdeals.co.nz/images/twitter-icon.png" alt="Follow on Twitter" width="40"
						height="40" /> </a><a href="http://www.facebook.com"> <img
						src="http://www.idealdeals.co.nz/images/facebook-icon.png" alt="Follow on Facebook" width="40"
						height="40" /> </a>
					</div>
				</div>
